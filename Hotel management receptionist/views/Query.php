...
<br>
	...
	<br>
    <br>
<h1 style=" color: blue; text-align:centre;">Anything You Want To Know</h1>
...
<textarea name="complain" id="complain" rows="8" cols="40" placeholder="Please Enter Your Query"></textarea>
<br>
<br>
<br>
...
xhttp.open("POST", "../controller/Query.php", true);
...
document.getElementById("p2").innerHTML = xhttp.responseText;
 ...
 xhttp.open("GET", "../controller/Query.php?searchKey=" + searchKey, true);
xhttp.send();
}
